...
<section <?php echo !empty($custom_id) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" <?php echo $parallaxdiv; ?> style="<?php echo $bg . $othercss; ?>">
    ...
    ?>
  	<div class="container">
        ...
        <div class="row align-items-start products-nav-list">
            <?php while (have_rows('products')): the_row();
                // vars
                $product = get_sub_field('product_page');
                $icon = get_field('parasoft_product_icon',$product);
            ?>
        ...
        <?php while (have_rows('products')): the_row();
			...
			<div class="product-container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 images-col">
                        <div class="images-container">
                            <img src="<?php echo $img1;?>"/>
                            <img src="<?php echo $img2;?>"/>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 info-col">
                        <div class="info-container">
                            ...
                            <div class="buttons">
                                <a class="btn blue-btn" href="<?php echo get_the_permalink($product); ?>">Learn More</a>
                                <a class="btn gray-btn" href="<?php echo get_the_permalink($demo); ?>">Request Demo</a>
                            </div>
                        </div>
                    </div>
                </div>
