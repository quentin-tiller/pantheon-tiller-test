...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'compliances-block-sec';
...
<section <?php echo !empty($custom_id) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" <?php echo $parallaxdiv; ?> style="<?php echo $bg . $othercss; ?>">
    ...
    <?php
	 ...
	 $button = get_sub_field('tool_qualification_kits');
    ?>
  <div class="container">
		<div class="row">
		...
		<div class="compliances-block-wrap">
			<div class="row">

				<?php foreach($links as $link){ ?>

					<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 compliances-block-list">
						<div class="compliances-block">
							<a href="<?=$link['link']['url']?>" title="<?=$link['link']['title']?>"><?=$link['link']['title']?> <i></i></a>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 compliances-block-list">
					<div class="compliances-block-full">
					 <?php if($button){ ?>		
		
						<a href="<?php echo $button['url']; ?>" title="<?php echo $button['title']; ?>"><?php echo $button['title']; ?> <i></i></a>
