...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'labeled-carousel-block';
...
<section <?php echo !empty($custom_id) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" <?php echo $parallaxdiv; ?> style="<?php echo $bg . $othercss; ?>">
    ...
    <div class="container">
		...
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
				<div class="labeled-carousel-wrap">
					<div class="labeled-carousel-slider-main">
						<div class="labeled-carousel-nav">
							<ul>
						...
						<div class="labeled-carousel-slider">
						<?php while (have_rows('slide')) : the_row(); 
							   $heading = get_sub_field('heading');
							   ...
							   $image = get_sub_field('image');
								?>
							<div class="item">
								<div class="labeled-carousel-slider-wrap">
									<div class="labeled-carousel-slider-desc">
								 ...
								 <?php if($image){ ?>	
									<div class="labeled-carousel-slider-img"> 
