...
<section <?php echo !empty($custom_id) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" <?php echo $parallaxdiv; ?> style="<?php echo $bg . $othercss; ?>">
	...
	<?php
     $columns_per_row = get_sub_field('cards_per_row');
	   ...
	   <div class="row">
		...
		<?php while (have_rows('cards')) : the_row(); 
                       ...
                       $link = get_sub_field('button');
                        ?>
            <div class="<?php echo $widthclass; ?> col-md-6 col-sm-12 cards-block-list">
				<a href="<?php echo $link['url']; ?>" title="<?php echo $heading; ?>" target="<?php echo $link['target']; ?>">
					<div class="cards-block-cont">
						<h2><?php echo $heading; ?></h2>
						<?php echo $content; ?>
					</div>
				  <?php if($link){ ?>		
					<div class="cards-block-btn">
						<span><?php echo $link['title']; ?> <i></i></span>
					</div>
				  <?php } ?>	
				</a>
			</div>
