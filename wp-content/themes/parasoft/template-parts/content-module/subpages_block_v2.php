...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'subpages-block-v2';
...
<section <?php echo !empty($custom_id) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" <?php echo $parallaxdiv; ?> style="<?php echo $bg . $othercss; ?>">
    ...
    <div class="container">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-2 col-lg-3 col-md-12 parent-col">
                <ul>
                <?php while(have_rows('parent_pages')){ the_row();
                    $parent_page = get_sub_field('parent_page');
                ?>
                    <li><span><?php echo $parent_page; ?></span></li>
                <?php } ?>
                </ul>
            </div>

            <div class="col-xl-10 col-lg-9 col-md-12 subpages-col">

                <?php while(have_rows('parent_pages')){ the_row();
                    $img = get_sub_field('image');
                    $content = get_sub_field('content');
                    $subpages = get_sub_field('sub_pages_list');
                ?>

                <div class="subpages-container"
                    <?php if ($background_type == 'none'){ ?>
                ...
                >
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-7 col-lg-7 col-md-7 col-sm-7 col-sm-12 image-col">
                            <img src="<?php echo $img['url'];?>"/>
                            <a class="fifty-fifty-bg-popup" href="<?php echo $img['url'];?>"></a>
                        </div>

                        <div class="col-xl-5 col-lg-5 col-md-5 col-sm-5 col-sm-12 content-col">
                            <div class="content">
                            ...
                            <div class="subpages-list">
                                <ul>
                                    ...
                                    <li><a href="<?php echo $subpage['sub_pages']['url'];?>"><?php echo $subpage['sub_pages']['title'];?>&nbsp;&rsaquo;</a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
