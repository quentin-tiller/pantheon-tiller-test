...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'products-block-sec alt-v2';
...
<section <?php echo !empty($custom_id) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" <?php echo $parallaxdiv; ?> style="<?php echo $bg . $othercss; ?>">
    ...
    <?php
     ...
     $choose_sharp_corner = get_sub_field('choose_sharp_corner');
    ?>
  <?php if($choose_sharp_corner == 1){ ?> 
   <div class="products-block-top-shape" style="background-color:#89d22f"></div>
   <div class="products-block-bottom-shape" style="background-color:#0e93d2"></div>
  <?php } ?>
    <div class="container">
        ...
        <?php if (have_rows('products')): ?>
                                ...
                                while (have_rows('products')): the_row();
                                    ...
                                    $parasoft_product_icon = get_field('parasoft_product_icon',$product);
                                    ?>

                                    
                         <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 products-block-list animation bottom-up">
                                <a href="<?php echo get_the_permalink($product); ?>" title="<?php echo get_the_title($product); ?>">
                                    <div class="products-block-wrap">
                                        <div class="products-block-logo">
                                            <img class="svg" src="<?php echo $parasoft_product_icon['url'];?>" alt="<?php echo $parasoft_product_icon['alt'];?>">
