...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'styled-list-block';
	...
	<div class="container">
		...
		<div class="row animation-box">
			<?php while ( have_rows( 'list' ) ) : the_row();
				...
				?>
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 styled-block-list animation bottom-up">
					<div class="styled-list-block-wrap">
						<div class="icon">
							<img
								src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/column-list-icon.svg"
								alt="">
						</div>
						<div class="styled-list-cont">
							<h3><?php echo $heading; ?></h3>
							<p><?php echo $content; ?></p>
							<?php if ( $link ) { ?>
								<div class="styled-list-btn">
