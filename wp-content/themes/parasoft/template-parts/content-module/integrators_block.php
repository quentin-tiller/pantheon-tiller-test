...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'integrators-block';
...
<section <?php echo !empty($custom_id) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" <?php echo $parallaxdiv; ?> style="<?php echo $bg . $othercss; ?>">
	...
	<?php
     $integrators = get_sub_field('integrators');
    ?>
   ...
   <div class="container">
		...
		<div class="row">
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
				<div class="integrators-logo-wrap">
				
				 <?php while (have_rows('integrators')) : the_row(); 
                       $logo = get_sub_field('logo');
                       $title = get_sub_field('title');
                       $description = get_sub_field('description');
                        ?>
                   <div class="integrators-logo">
