...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'cta-fifty-fifty-block';
...
<section <?php echo !empty($custom_id) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" <?php echo $parallaxdiv; ?> style="<?php echo $bg . $othercss; ?>">
  ...
  <?php if($choose_sharp_corner == 1){ ?> 
   <div class="cta-fifty-fifty-top-shape" style="background-color:#89d22f"></div>
  <?php } ?>
  	<div class="container">
		<div class="row">
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
				<div class="cta-fifty-fifty-lt-cont">
					<?php echo $left_content; ?>
				</div>
			</div>
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
				<div class="cta-fifty-fifty-rt-cont">
