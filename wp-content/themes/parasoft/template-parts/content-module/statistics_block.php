...
$parallaxdiv     = '';
$bg              = '';
$sectionclass[]  = 'statistics-block-sec';

while ( have_rows( 'statistics_block_module', 'option' ) ) : the_row();
...
<section <?php echo ! empty( $custom_id ) ? ' id="' . $custom_id . '" ' : ''; ?> class="<?php echo $sec_class; ?>" style="<?php echo $bg . $othercss; ?>">
	...
	<div class="container">
		...
		<div class="row counter" id="counter">
			<?php
			if ( have_rows( 'statistics_block_module', 'option' ) ): while ( have_rows( 'statistics_block_module', 'option' ) ) : the_row();
				if ( have_rows( 'stats' ) ): ?>
					<?php
					$count = 1;
					while ( have_rows( 'stats' ) ): the_row();
						...
						<div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 counter-list">
							<div class="counter-wrap">
								<h3><?php echo $heading; ?></h3>
								<h4><?php echo $prefix; ?><span><?php echo $stat; ?></span><?php echo $suffix; ?></h4>
