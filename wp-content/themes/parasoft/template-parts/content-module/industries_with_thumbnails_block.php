...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'industries-with-thumbnails-block';
...
<section <?php echo ! empty( $custom_id ) ? ' id="' . $custom_id . '" ' : ''; ?>
	...
	$industries_type = get_sub_field( 'industries_type' );
	$posts           = get_sub_field( 'manual_selection' );
						...
						<div class="industries-block-wrap">
							<a href="<?php echo get_permalink( $id ); ?>" title="<?php echo get_the_title(); ?>">
								<?php if ( $industry_image ) {
									$imageurl = $industry_image['url'];
								} else {
									$imageurl = get_template_directory_uri() . '/dist/assets/images/automotive.jpg';
								}
								?>
								<div class="industries-block-bg"
								     style="background-image:url('<?php echo $imageurl; ?>');">
									<div class="industries-block-overlay">
										<div class="industries-block-btn">
			...
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
					<div class="text-center">
						<a class="btn <?php echo $button_color; ?>" href="<?php echo $button['url']; ?>"
