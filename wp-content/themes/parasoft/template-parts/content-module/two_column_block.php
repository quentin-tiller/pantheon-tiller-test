		...
		<div class="row">
			<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
				...
				<?php
					...
					<div class="two-column-block-cont">
						<?php echo $content; ?>
					</div>
					<?php
						...
						?>
						<div class="two-column-block-btn">
                            <?php
                            while ( have_rows('buttons') ) : the_row(); 
                            $link = get_sub_field('button');
                            ?>

                            <a class="wista-video btn red-btn" href="<?php echo $link['url']; ?>" target="<?php echo $link['target']; ?>"><?php echo $link['title']; ?></a>	
                            <?php	
                            endwhile; 
                            ?>
						</div>
                    
                        <?php elseif( have_rows('buttons_nopopup') ):
						?>
						<div class="two-column-block-btn">
                            <?php
                            while ( have_rows('buttons_nopopup') ) : the_row(); 
                            $link = get_sub_field('button');
                            ?>

                            <a class="alt-arrow btn red-btn" href="<?php echo $link['url']; ?>" target="<?php echo $link['target']; ?>"><?php echo $link['title']; ?></a>	
                            <?php	
                            endwhile; 
						    ?>
						</div>
