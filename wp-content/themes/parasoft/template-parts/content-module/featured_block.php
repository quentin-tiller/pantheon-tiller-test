		...
		<div class="row animation-box">
		 <?php while (have_rows('feature')) : the_row(); 
               ...
               $link = get_sub_field('link');
                ...
                ?>
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6 col-xs-12 featured-v2-col animation bottom-up">
				<a href="<?php echo $link ?>" title="<?php echo $text ?>">
					<div class="featured-v2-container">
						<img class="featured-v2-img" src="<?php echo $image['url'];?>"/>
                        <div class="featured-v2-content">
						  <h3><?php echo $text; ?></h3>
                        </div>
					</div>
				</a>
