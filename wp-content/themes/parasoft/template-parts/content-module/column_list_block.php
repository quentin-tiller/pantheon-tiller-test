...
$parallaxdiv = '';
$bg = '';
$sectionclass[] = 'column-list-block';
...
<section <?php echo ! empty( $custom_id ) ? ' id="' . $custom_id . '" ' : ''; ?>
	...
	<?php
	$columns            = get_sub_field( 'subheading' );
	$button             = get_sub_field( 'button' );
	$button_color       = get_sub_field( 'button_color_picker' );
	$choose_video_popup = get_sub_field( 'choose_video_popup' );
	if ( $choose_video_popup == 1 ) {
		$popupclass = 'vieo-open';
	} else {
		$popupclass = '';
	}
	?>
	...
	<div class="container">
		...
		<div class="row animation-box" style="<?php echo ($vertical_alignment == 'center')? 'align-items: center': ''; ?>">
			<?php while ( have_rows( 'columns' ) ) : the_row();
				...
				?>
				<div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 column-block-list animation bottom-up">
					<div class="column-list-block-wrap">
						<div class="column-list-block-icon">
							<img
								src="<?php echo get_template_directory_uri(); ?>/dist/assets/images/column-list-icon.svg"
								alt="">
						</div>
						<div class="column-list-block-cont">
		...
		<?php if ( $button ) { ?>
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
					<div class="featured-news-btn text-center">
						<a class="btn <?php echo $button_color; ?> <?php echo $popupclass; ?>"
